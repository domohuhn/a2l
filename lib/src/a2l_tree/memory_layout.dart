...
MemoryLayoutType memoryLayoutTypeFromString(Token t) {
  switch(t.text) {
    case 'PRG_CODE'    : return MemoryLayoutType.PRG_CODE    ;
    case 'PRG_DATA'    : return MemoryLayoutType.PRG_DATA    ;
    case 'PRG_RESERVED': return MemoryLayoutType.PRG_RESERVED;
...
String memoryLayoutTypeToString(MemoryLayoutType e) {
  switch(e) {
    case MemoryLayoutType.PRG_CODE    : return 'PRG_CODE'    ;
    case MemoryLayoutType.PRG_DATA    : return 'PRG_DATA'    ;
    case MemoryLayoutType.PRG_RESERVED: return 'PRG_RESERVED';
