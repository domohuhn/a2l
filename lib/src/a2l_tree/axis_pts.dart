...
Monotony monotonyFromString(Token t) {
  switch(t.text) {
    case 'MON_DECREASE'   : return Monotony.decreasing         ;
    case 'MON_INCREASE'   : return Monotony.increasing         ;
    case 'STRICT_DECREASE': return Monotony.strictly_decreasing;
    case 'STRICT_INCREASE': return Monotony.strictly_increasing;
    case 'MONOTONOUS'     : return Monotony.monotonous         ;
    case 'STRICT_MON'     : return Monotony.strictly_monotonous;
    case 'NOT_MON'        : return Monotony.not_monotonous     ;
    default: throw ParsingException('Unknown monotony for axis', t);
  }
}

/// Converts a Monotony [e] to the a2l string
String monotonyToString(Monotony t) {
  switch(t) {
    case Monotony.decreasing         : return 'MON_DECREASE'   ;
    case Monotony.increasing         : return 'MON_INCREASE'   ;
    case Monotony.strictly_decreasing: return 'STRICT_DECREASE';
    case Monotony.strictly_increasing: return 'STRICT_INCREASE';
    case Monotony.monotonous         : return 'MONOTONOUS'     ;
    case Monotony.strictly_monotonous: return 'STRICT_MON'     ;
    case Monotony.not_monotonous     : return 'NOT_MON'        ;
    default: throw ValidationError('Unknown monotony for axis $t');
  }
}
