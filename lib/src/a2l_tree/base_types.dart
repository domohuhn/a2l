...
Datatype dataTypeFromString(Token s) {
  switch (s.text) {
    ...
    default:
      throw ParsingException('Unknown data type', s);
  }
}
...
enum ByteOrder { MSB_LAST, MSB_FIRST }
...
ByteOrder byteOrderFromString(Token s) {
  switch (s.text) {
    ...
    case 'LITTLE_ENDIAN':
      return ByteOrder.MSB_FIRST;
    default:
      throw ParsingException('Unknown byte order', s);
  }
}
...
IndexMode indexModeFromString(Token s) {
  switch (s.text) {
    ...
    default:
      throw ParsingException('Unknown index mode', s);
  }
}
...
String indexModeToString(IndexMode s) {
  switch (s) {
    case IndexMode.ALTERNATE_CURVES:
      return 'ALTERNATE_CURVES';
    case IndexMode.ALTERNATE_WITH_X:
      return 'ALTERNATE_WITH_X';
    case IndexMode.ALTERNATE_WITH_Y:
      return 'ALTERNATE_WITH_Y';
    case IndexMode.COLUMN_DIR:
      return 'COLUMN_DIR';
...
MaxRefreshUnit maxRefreshUnitFromString(Token s) {
  switch (s.text) {
    case '0':
      return MaxRefreshUnit.time_1usec;
    case '1':
      return MaxRefreshUnit.time_10usec;
    case '2':
      return MaxRefreshUnit.time_100usec;
    case '3':
      return MaxRefreshUnit.time_1msec;
    case '4':
      return MaxRefreshUnit.time_10msec;
    case '5':
      return MaxRefreshUnit.time_100msec;
    case '6':
      return MaxRefreshUnit.time_1sec;
    case '7':
      return MaxRefreshUnit.time_10sec;
    case '8':
      return MaxRefreshUnit.time_1min;
    case '9':
      return MaxRefreshUnit.time_1hour;
    case '10':
      return MaxRefreshUnit.time_1day;
    case '100':
      return MaxRefreshUnit.angle_degree;
    case '101':
      return MaxRefreshUnit.angle_revolutions_360_degree;
    case '102':
      return MaxRefreshUnit.angle_cycle_720_degree;
    case '103':
      return MaxRefreshUnit.combustion_cylinder_segment;
    case '998':
    ...
    default:
      throw ParsingException('Unknown ScalingUnit', s);
  }
}
...
String maxRefreshUnitToString(MaxRefreshUnit s) {
  switch (s) {
    case MaxRefreshUnit.time_1usec:
      return '0';
    case MaxRefreshUnit.time_10usec:
      return '1';
    case MaxRefreshUnit.time_100usec:
      return '2';
    case MaxRefreshUnit.time_1msec:
      return '3';
    case MaxRefreshUnit.time_10msec:
      return '4';
    case MaxRefreshUnit.time_100msec:
      return '5';
    case MaxRefreshUnit.time_1sec:
      return '6';
    case MaxRefreshUnit.time_10sec:
      return '7';
    case MaxRefreshUnit.time_1min:
      return '8';
    case MaxRefreshUnit.time_1hour:
      return '9';
    case MaxRefreshUnit.time_1day:
      return '10';
    case MaxRefreshUnit.angle_degree:
      return '100';
    case MaxRefreshUnit.angle_revolutions_360_degree:
      return '101';
    case MaxRefreshUnit.angle_cycle_720_degree:
      return '102';
    case MaxRefreshUnit.combustion_cylinder_segment:
      return '103';
...
AddressType addressTypeFromString(Token s) {
  switch (s.text) {
    case 'PBYTE':
      return AddressType.PBYTE;
    case 'PWORD':
      return AddressType.PWORD;
    case 'PLONG':
      return AddressType.PLONG;
    case 'DIRECT':
      return AddressType.DIRECT;
    default:
      throw ParsingException('Unknown address type $s', s);
  }
}
...
String addressTypeToString(AddressType s) {
  switch (s) {
    case AddressType.PBYTE:
      return 'PBYTE';
    case AddressType.PWORD:
      return 'PWORD';
    case AddressType.PLONG:
      return 'PLONG';
...
Deposit depositFromString(Token s) {
  switch (s.text) {
    ...
    default:
      throw ParsingException('Unknown deposit type', s);
  }
}
