...
AxisType axisTypeFromString(Token t){
  switch(t.text) {
    case 'CURVE_AXIS': return AxisType.curve   ;
    case 'COM_AXIS'  : return AxisType.com_axis;
    case 'FIX_AXIS'  : return AxisType.fixed   ;
    case 'RES_AXIS'  : return AxisType.rescale ;
    case 'STD_AXIS'  : return AxisType.standard;
    default: throw ParsingException('Unknown axis type', t);
  }
}
...
String axisTypeToString(AxisType t){
  switch(t) {
    case AxisType.curve   : return 'CURVE_AXIS';
    case AxisType.com_axis: return 'COM_AXIS'  ;
    case AxisType.fixed   : return 'FIX_AXIS'  ;
    case AxisType.rescale : return 'RES_AXIS'  ;
    case AxisType.standard: return 'STD_AXIS'  ;
    default: throw ValidationError('Unknown axis type $t');
  }
}
