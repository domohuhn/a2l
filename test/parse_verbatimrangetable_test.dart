...
void main() {
  ...
  group('Parse verbatim table range', (){
    test('Parse mandatory', (){
      prepareTestData(parser, ['/begin','COMPU_VTAB_RANGE','test_ct', '"This is a test ct"', '3', 
      '1', '1', '"A"', '2', '5.0', '"BB"', '5', '1000', '"CCC"',
      ...
      expect(file.project.modules[0].computeTables[0].table[0].x_up, 1.0);
      expect(file.project.modules[0].computeTables[0].table[0].isFloat, false);
      expect(file.project.modules[0].computeTables[0].table[1].x_up, 5.0);
      expect(file.project.modules[0].computeTables[0].table[1].isFloat, true);
      expect(file.project.modules[0].computeTables[0].table[2].x_up, 1000.0);
    ...
    test('Parse mandatory mutiple', (){
      prepareTestData(parser, [
        '/begin','COMPU_VTAB_RANGE','test_ct', '"This is a test ct"', '3', 
      '1', '1', '"A"', '2', '5.0', '"BB"', '5', '1000', '"CCC"',
      '/end', 'COMPU_VTAB_RANGE',
      '/begin','COMPU_VTAB_RANGE','test_ct2', '"This is a test ct2"', '2', 
      '1.0', '5.0', '"X"', '5.0', '9.0', '"YY"',
      '/end', 'COMPU_VTAB_RANGE']);
      var file = parser.parse();
      expect(file.project.modules.length, 1);
      expect(file.project.modules[0].computeTables[0].name, 'test_ct');
      ...
      expect(file.project.modules[0].computeTables[1].table[0].x_up, 5.0);
      ...
      expect(file.project.modules[0].computeTables[1].table[1].x_up, 9.0);
    ...
    test('Parse optional DEFAULT_VALUE', (){
      prepareTestData(parser, ['/begin','COMPU_VTAB_RANGE','test_ct', '"This is a test ct"', '3', 
      '1', '1', '"A"', '2', '5.0', '"BB"', '5', '1000', '"CCC"', 'DEFAULT_VALUE', '"N/A"',
      '/end', 'COMPU_VTAB_RANGE']);
      var file = parser.parse();
      expect(file.project.modules.length, 1);
      expect(file.project.modules[0].computeTables.length, 1);
