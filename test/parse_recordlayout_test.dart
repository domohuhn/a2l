...
void main() {
  ...
  group('Parse record layouts mandatory', () {
    test('Parse mandatory', () {
      ...
      expect(rls[0].alignmentFloat32, null);
      expect(rls[0].alignmentFloat64, null);
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, null);
      expect(rls[0].alignmentInt64, null);
    ...
    test('Parse mandatory multiple', () {
      ...
      expect(rls[1].alignmentFloat32, null);
      expect(rls[1].alignmentFloat64, null);
      expect(rls[1].alignmentInt8, null);
      expect(rls[1].alignmentInt16, null);
      expect(rls[1].alignmentInt32, null);
      expect(rls[1].alignmentInt64, null);
  ...
  group('Parse record layouts optional', () {
    ...
    test('Parse optional ALIGNMENT_LONG', () {
      ...
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, 11);
      expect(rls[0].alignmentInt64, null);
      expect(rls[0].values, null);
    });
    ...
    test('Parse optional ALIGNMENT_WORD', () {
      ...
      expect(rls[0].alignmentFloat64, null);
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, 11);
      expect(rls[0].alignmentInt32, null);
      expect(rls[0].alignmentInt64, null);
      expect(rls[0].values, null);
    });
    ...
    test('Parse optional ALIGNMENT_INT64', () {
      ...
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, null);
      expect(rls[0].alignmentInt64, 13);
      expect(rls[0].values, null);
    });
    ...
    test('Parse optional ALIGNMENT_FLOAT32_IEEE', () {
      ...
      expect(rls.length, 1);
      expect(rls[0].name, 'TEST.RL');
      expect(rls[0].alignmentFloat32, 5);
      expect(rls[0].alignmentFloat64, null);
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, null);
    ...
    test('Parse optional ALIGNMENT_FLOAT64_IEEE', () {
      ...
      expect(rls[0].name, 'TEST.RL');
      expect(rls[0].alignmentFloat32, null);
      expect(rls[0].alignmentFloat64, 17);
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, null);
      expect(rls[0].alignmentInt64, null);
    ...
    test('Parse optional ALIGNMENT_INT64', () {
      ...
      expect(rls[0].name, 'TEST.RL');
      expect(rls[0].alignmentFloat32, null);
      expect(rls[0].alignmentFloat64, 7);
      expect(rls[0].alignmentInt8, null);
      expect(rls[0].alignmentInt16, null);
      expect(rls[0].alignmentInt32, null);
      expect(rls[0].alignmentInt64, null);
